...
_use_ a scale signature, that has already been generated. This means that the imported 'scale' package, in either Golang, JS, or Rust, will point to the scale func specified.
