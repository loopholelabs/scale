...
[Typescript/Javascript](/languages/javascript-typescript/overview#importing-scale-functions) to learn how to use your function inside your existing services.
