...
<Note>
    ...
    service as soon as it's available, please [join our discord](https://loopholelabs.io/discord).
</Note>

This guide has instructions for installing the toolchain for both languages, but you can skip the one that you don't need.
