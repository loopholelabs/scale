...
```
 ...
 ------------------- -------- ------------- ---------- ------------- ------------------------------------------------------------------ ---------
  hello-world         1.0     local         rust       http@v0.3.4   8dad03b701cd124b55ff5caf7a36a9af5d19759fc73a9e8299bea4816f929777   v1alpha
```
...
```bash
scale run local/hello-world:1.0
```
...
```bash
scale run local/hello-world:1.0 -l :3000
```
...
```bash
scale function push hello-world:1.0
```
...
```bash
scale function push hello-world:1.0 --public
```
...
```bash
scale function pull <your organization>/hello-world:1.0
```
...
```bash
scale function pull <your organization>/hello-world:1.0 --cache-directory /path/to/directory
```
