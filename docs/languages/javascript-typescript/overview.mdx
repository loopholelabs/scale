...
Once you've imported your Scale Function(s) into your TS/JS application, you can create a new instance of the Scale Runtime, passing the function, as well as a new `Config`, with a `NewSiginature`. :w
