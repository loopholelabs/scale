...
// source: runtime/context/generated/generated.proto
...
func (x *Request) Encode(b *polyglot.Buffer) {
	if x == nil {
		...
		polyglot.Encoder(b).String(x.Method).Int64(x.Length).String(x.Protocol).String(x.Ip).Bytes(x.Body)
		x.Headers.Encode(b)
	}
}
